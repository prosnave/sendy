...
exports.latlong = function (message) {
    return exports.regexp(/^-?[0-9]{1,3}[.][0-9]+$/, message || 'Please enter a GPS value.');
};
...
exports.number = function (message) {
    return exports.regexp(/^[0-9]+$/, message || 'Numbers only please.');
};
